...
public partial class chart5 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Select = "Select * From userreg where Field='5'";
    ...
    protected void bindgrid()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from userreg where Field=5", con);
