...
public partial class chart1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Select = "Select * From userreg where Field='1'";
        ...
        ChartID.Legends.Add("average_marks").Title = "Clustering Under Field 1";
    ...
    protected void bindgrid()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from userreg where Field=1", con);
